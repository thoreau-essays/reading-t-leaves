...
> **Note:** This documentation describes the legacy `config-theme-colors.csv` system from CollectionBuilder-CSV.
>
> **CB-Essay uses a new theming system** with built-in color themes and coordinated typography. See:
> - [Theme Options Guide](cb-essay/theme-options.md) for the current theming system
> - `_data/theme.yml` → `color-theme` option
> - `_sass/_color-tokens.scss` for theme definitions
> - `_prompts/add-theme.md` for adding custom themes

---

## Legacy CollectionBuilder Color Customization
