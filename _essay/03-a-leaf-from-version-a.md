...
The page is a partial leaf. At the top left, Thoreau has edited the first sentence in ink.

{% include essay/feature/scrolly-step.html map-x="4000" map-y="3000" map-zoom="4" %}
...
There is a penciled "P.17" in the upper left corner of the page, but this is in F.B. Sanborn's hand, not Thoreau's. Six lines from the top of the page, Thoreau inserts "he talks" in ink following "all the while," and he uses a curved line &mdash; a standard transposition symbol &mdash; to indicate that the order of words here should be "walking all the while he talks." As he often does throughout the manuscript, Thoreau draws the line in pencil, then draws over it in ink.

{% include essay/feature/scrolly-step.html map-x="6000" map-y="3000" map-zoom="4" %}

An inked insertion on the next line amends the last part of "whose vegetable-made bones jerk his \[oxen\]" to "jerk him &amp; his \[oxen\]". On the line below that, Thoreau, in pencil, cancels "through" and replaces it with "in spite of."  

{% include essay/feature/scrolly-step.html map-x="5000" map-y="6030" map-zoom="4" %}

Still farther down, we find the penciled word "omit," probably added by Thoreau and apparently referring to everything below the penciled line beneath.

{% include essay/feature/scrolly-step.html map-x="3000" map-zoom="3" animate="zoom-out" %}
